<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AEditproduct.aspx.cs" Inherits="AEditproduct" %>
                ...
                <div class="panel panel-default card-view">
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                <div>
                                    <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>Edit Product</h6>
                                    ...
                                    <div class="form-actions">
                                        <asp:Button ID="Button1" runat="server" Text="Update" class="btn btn-success btn-icon left-icon mr-10 pull-left" OnClick="Button1_Click" />

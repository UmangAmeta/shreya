<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Aviewgallery.aspx.cs" Inherits="Aviewgallery" %>
                                    ...
                                    <article class="col-item" style="min-height: 250px; max-height:300px;">
                                        <div class="photo">
                                            <div class="options">
                                                ...
                                                <asp:LinkButton ID="LinkButton1" CommandName="Remove" CommandArgument='<%# Eval("Imageid") %>' runat="server" CssClass="font-18 txt-grey pull-left sa-warning zmdi zmdi-close"></asp:LinkButton>
                                            </div>
